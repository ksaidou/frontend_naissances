...
function Nav() {
  return (
    <nav className="z-10 bg-slate-50 shadow-md w-56 fixed flex flex-col justify-between top-0 bottom-0 left-0">
        ...
        <button type="button" onClick={()=>null} className="bg-red-700 text-white font-normal py-2 rounded-md hover:border hover:border-red-700 hover:bg-white hover:text-red-700">Déconnexion</button>
    </nav>
  )
}
